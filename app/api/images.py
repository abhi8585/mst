...
api_namespace = Namespace('Images', description="Image Service API", path='/images')
...
class Images(Resource):
    ...
    def __init__(self, *args, **kwargs):
        ...
        pages = paginator.paginate(Bucket='dp-bucket',PaginationConfig={'PageSize': 10}) #chanag the Page size value for perpage result
    ...
    def get(self,page_id):
        ...
        for page in self.pages_list[page_id]['Contents']:
            #print(page['Key'])
            resp['data'].append("{}/{}/{}".format(config('AWS_ENDPOINT_URL'),"dp-bucket",page['Key']))
