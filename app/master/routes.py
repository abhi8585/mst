...
from app.models import role, userinfo, usertorole, auditvendor, auditortovendor, distvendor, disttovendor, sku
from .. import db
...
def listtransvendor():
    # vendors = distvendor.query.all()
    return render_template("list-trans-vendor-form.html")
...
def listtransporter():
    # vendors = distvendor.query.all()
    return render_template("list-trans-form.html")

@blueprint.route('/create/transporter')
def createtransporter():
    # vendors = distvendor.query.all()
    return render_template("create-trans-form.html")